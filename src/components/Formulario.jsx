...
//HACEMOS useEffect PARA BOTON EDITAR
  useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    if (paciente.id) {
      ...
      //SETEAMOS EL PACIENTE AGREGADO AL ARRAY PACIENTES   
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <form 
          ...
          <div className=" mb-5">
            <label htmlFor="email" className="block text-gray-700 uppercase">Email del Propietario</label>
            <input 
              type="email"
